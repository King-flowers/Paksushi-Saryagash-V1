...
const DATA = {
  sets: [
...

    {
      ...
      price:16490,
      short:'🍣 100 шт суши + 🍕 пеперони + 🍕 маргарита + 🍕 пеперони',
...

    {
      ...
      price:15990,
      short:'🍣 100 шт суши + 🍕 пеперони + 🍕 маргарита + 🍕 4 сезона',
      desc:'🍣 Филадельфия — 20 шт\n🍣 Калифорния — 10 шт\n🍣 Инь Янь — 10 шт\n🍣 Темпура — 30 шт\n🍣 Цезарь запечённый — 10 шт\n🍣 Цезарь — 20 шт\n🍕 Пеперони — 1 шт\n🍕 Маргарита — 1 шт\n🍕 4 сезона — 1 шт'
    },

    {
      ...
      price:18990,
      short:'🍣 100 шт суши + 🍕 4 сезона + 🍕 маргарита + 🍕 пеперони  + 🍕 пеперони + 🍕 грибная',
      desc:'🍣 Филадельфия — 20 шт\n🍣 Калифорния с тобико — 10 шт\n🍣 Инь Янь — 10 шт\n🍣 Цезарь темп — 30 шт\n🍣 Америка — 30 шт\n🍕 4 сезона — 1 шт\n🍕 Маргарита — 1 шт\n🍕 Пеперони — 2 шт\n🍕 Грибная — 1 шт'
    },
    {
      name:'Экономный',
...

    {
      ...
      price:null,
      short:'Сет Саламалейкум 🤲🔥\n🍣 52 шт роллов',
      desc:'🍣 Зеленый зверь — 18 шт\n🍣 Калифорния — 18 шт\n🍣 Темпура — 16 шт'
    },
...

    {
      ...
      category:'big',
      popular:false,
      img:'images/sets/Set-Marvel.jpg',
      price:null,
      short:'Сет Марвел 🦸🔥\n🍣 90+ шт роллов',
      desc:'🍣 Филадельфия — 24 шт\n🍣 Темпура — 24 шт\n🍣 Канада — 24 шт\n🍣 Классика — 20 шт'
    },
...

    {
      ...
      price:null,
      short:'Сет Корпаратив 🎉🔥\n🍣 120 шт роллов',
      desc:'🍣 Филадельфия — 30 шт\n🍣 Темпура — 30 шт\n🍣 Унаги — 30 шт\n🍣 Запечённый — 30 шт'
    },
...

    {
      ...
      category:'small',
      popular:false,
      img:'images/sets/Set-Zvl.jpg',
      price:null,
      short:'Сет Звл 💫🔥\n🍣 50 шт роллов',
      desc:'🍣 Зеленый зверь — 20 шт\n🍣 Цезарь — 15 шт\n🍣 Канада — 15 шт'
    },
  ...
  sushi: [
    ...
    {name:'Канада', price:null, img:'images/blyudo/Kanada.jpg'},
    {name:'Унаги Темпура', price:null, img:'images/blyudo/Unagi-Tem.jpg'},
    {name:'Аляска', price:1890, img:'images/blyudo/Alyaska.jpg'},
    {name:'Калифорния', price:1890, img:'images/blyudo/Kalifornia.jpg'},
    {name:'Бонита', price:1890, img:'images/blyudo/Bonita.jpg'},
    {name:'Сингапур', price:2090, img:'images/blyudo/Singapure.jpg'},
    {name:'Капа Маки', price:1590, img:'images/blyudo/Kapa-Maki.jpg'},
    {name:'Эби Темпура', price:null, img:'images/blyudo/Ebi-Tempura.jpg'},
    {name:'Запеченный с угрём', price:null, img:'images/blyudo/Zap-SUgr.jpg'},
    {name:'Дракон (с помидором)', price:1590, img:'images/blyudo/Drakon-Lasos.jpg'},
    {name:'Сяке Запечённый', price:2090, img:'images/blyudo/Sake-Zap.jpg'}
  ],
  pizza: [
    {name:'Маргарита', price:1890, img:'images/blyudo/Pizza-Margarita.jpg'},
    {name:'4 Сезона', price:2190, img:'images/blyudo/Pizza-4Sezon.jpg'},
    {name:'Пепперони', price:1890, img:'images/blyudo/Pizza-Peperoni.jpg'},
    {name:'Болоньез', price:null, img:'images/blyudo/Pizza-Boloneze.jpg'},
    {name:'Куриная', price:2090, img:'images/blyudo/Pizza-Chiken.jpg'},
    {name:'Казахстан', price:null, img:'images/blyudo/Pizza-Kazahstan.jpg'}
  ],
  snacks: [
    ...
    {name:'Кортофельные шарики 16шт', price:600, img:'images/blyudo/K-Shariki.jpg'},
    {name:'Фри', price:600, img:'images/blyudo/Free.jpg'},
    ...
    {name:'Корн дог 5шт', price:1200, img:'images/blyudo/Korn-Dog.jpg'},
    {name:'Сырные палочки 6шт', price:1290, img:'images/blyudo/S-Palochki.jpg'}
  ],
  drinks: [
    {name:'Фанта 1л', price:600, img:'images/blyudo/Fanta.png'},
    {name:'Кола 1л', price:600, img:'images/blyudo/Kola.jpg'},
    {name:'Фьюс-ти 1л', price:600, img:'images/blyudo/Fuse.jpg'},
    {name:'Макси чай 1л', price:600, img:'images/blyudo/Maxi.jpg'},
    {name:'Пепси 1л', price:600, img:'images/blyudo/Pepsi.jpg'},
    {name:'Горилла', price:500, img:'images/blyudo/Gorilla.jpg'},
    {name:'Диззи', price:500, img:'images/blyudo/Dizzi.jpg'},
    ...
    {name:'Холопеньо', price:150, img:'images/blyudo/Holopeno.jpg'}
  ]
};
